...
## S R Latch with Asynchronous reset
```
module sr_latch_Async_rst(S, R, clk, rst, Q);
  input S, R, clk, rst;
  output reg Q;
  reg temp;
...
```
## testbench for S R Latch with Asynchronous reset
```
module sr_latch_Async_rst_tb();
  reg S, R, clk, rst;
  wire Q;
  
  sr_latch_Async_rst dut (S, R, clk, rst, Q);
  ...
  initial begin
    $dumpfile("dump.vcd");
    $dumpvars(1,sr_latch_Async_rst_tb);
  end
  
endmodule
```
## waveform 
<img width="1402" alt="Screenshot 2025-05-14 at 1 07 33 AM" src="https://github.com/user-attachments/assets/2502c7be-6b5d-46f7-8957-5605243d5b1e" />
